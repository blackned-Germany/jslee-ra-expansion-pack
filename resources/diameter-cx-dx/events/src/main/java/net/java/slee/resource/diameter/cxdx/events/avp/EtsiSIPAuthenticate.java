...
/**
 * <pre>
 * <b>6.3.36  ETSI-SIP-Authenticate AVP</b>
 * The ETSI-SIP-Authenticate is of type Grouped and it contains a reconstruction of either the
 * SIP WWW-Authenticate or Proxy-Authentication header fields specified in IETF RFC 2617 [14].
 * 
 * AVP format
 * SIP-Digest-Authenticate ::= < AVP Header: 501 13019>
 *                         { ETSI-Digest-Realm }
 *                         { ETSI-Digest-Nonce }
 *                         { ETSI-Digest-Domain }
 *                         { ETSI-Digest-Opaque }
...
public interface EtsiSIPAuthenticate extends GroupedAvp {
  ...
  /**
   * Returns true if the Digest-Stale AVP is present in the message.
   */
  public boolean hasDigestStale();

  /**
   * Returns the value of the Digest-Stale AVP, of type UTF8String.
   * A return value of null implies that the AVP has not been set or some error has been encountered.
   */
  public String getDigestStale();

  /**
   * Sets the value of the Digest-Stale AVP, of type UTF8String.
   * @throws IllegalStateException if setDigestStale has already been called
   */
